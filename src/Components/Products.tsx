...
import MbCreatine from './contents/MbCreatine.webp'
import Biozyme from './contents/Biozyme.jpg';
import biozyme2 from './contents/biozyme2.jpg';
import creatine2 from './contents/creatine2.jpg';
import './Products.css';

function products() {
  return (
    <>
      <h2 className="text-center display-6">Listed Products</h2>
      <p className="text-center"><em>Here are some products listed below you are suggested to buy and the link is given.</em></p>
